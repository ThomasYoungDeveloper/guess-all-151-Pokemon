...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var pokemonList = setOf<String>("Bulbasaur", "Ivysaur", "Venusaur", "Charmander", "Charmeleon",
            ...
            "Pikachu", "Raichu", "Sandshrew", "Sandslash", "Nidoran", "Nidorina", "Nidoqueen", "Nidorino", "Nidoking",
